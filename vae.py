...
class VAE:
    ...
    def _add_dense_layer(self, decoder_input):
        num_neurons = np.prod(self._shape_before_bottleneck) # [4, 4, 32] -> 512
    ...
    def _add_conv_transpose_layers(self, x):
        ...
        # loop through all the conv layers in reverse order and stop a the first layer
    ...
    def _add_decoder_output(self, x):
        conv_transpose_layer = conv_transpose_layer = Conv2DTranspose(filters=1, # [24, 24, 1]
